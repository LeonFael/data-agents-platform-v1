...
import { CompletenessChart, HistogramChart, ColumnTypesChart } from './Charts'
import { BarChart2, MessageCircle, Table, Lightbulb, TrendingUp } from 'lucide-react'
...
export default function DatasetDashboard({ summary }) {
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px' }}>
        ...
        {activeTab === 'data' && (
          <div className="fade-up">
            ...
            <DataTable columnInfo={summary.column_info} rows={[]} headers={summary.column_info.map(c => c.name)} />
          </div>
        )}
